        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Elsa Preparatory And Junior Academy (E.P.J.A) integrates the
              current country's education system, producing excellent students
              who proceed to various high school institutions.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/m.u.r.d.a._" className="text-gray-400 hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/fee-structure" className="text-gray-300 hover:text-white">
                  Fee Structure
                </Link>
              </li>
              <li>
                <Link to="/newsletters" className="text-gray-300 hover:text-white">
                  Newsletters
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="mr-2 h-5 w-5 text-yellow-500 flex-shrink-0" />
              ...
              <li className="flex items-center">
                ...
                <a href="https://wa.me/+254728135200" className="text-gray-300 hover:text-white">
                  +254 728 135 200
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="mr-2 h-5 w-5 text-yellow-500" />
                <a href="mailto:ezranyamwange2@gmail.com" className="text-gray-300 hover:text-white">
